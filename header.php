...
<?php esc_html_e( 'Skip to content', 'ad-agency-lite' ); ?>
</a>
<?php
...
<div class="left">
		...
		<?php if (!empty($fb_link)) { ?><a title="<?php echo esc_attr__('Facebook','ad-agency-lite'); ?>" class="fb" target="_blank" href="<?php echo esc_url($fb_link); ?>"></a><?php } if (!empty($twitt_link)) { ?><a title="<?php echo esc_attr__('Twitter','ad-agency-lite'); ?>" class="tw" target="_blank" href="<?php echo esc_url($twitt_link); ?>"></a><?php } if (!empty($linked_link)) { ?><a title="<?php echo esc_attr__('Linkedin','ad-agency-lite'); ?>" class="in" target="_blank" href="<?php echo esc_url($linked_link); ?>"></a><?php } ?><?php if (!empty($insta_link)) { ?><a title="<?php echo esc_attr__('Instagram','ad-agency-lite'); ?>" class="insta" target="_blank" href="<?php echo esc_url($insta_link); ?>"></a><?php } ?>                   
      </div>
</div>
<div class="clear"></div>                
</div>
...
<div class="header">
	<div class="container">
    <div class="logo">
		<?php ad_agency_lite_the_custom_logo(); ?>
        <div class="clear"></div>
		<?php	
    ...
    <div id="navigation"><nav id="site-navigation" class="main-navigation">
		...
		<?php wp_nav_menu( array('theme_location' => 'primary', 'container' => 'ul', 'menu_id' => 'primary', 'menu_class' => 'primary-menu menu' ) ); ?>
            ...
            <div class="header-cart">
            	<a class="cart-customlocation" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'ad-agency-lite' ); ?>"> <img class="cart-customlocation" src="<?php echo esc_url(get_stylesheet_directory_uri());?>/images/cart-icon.png" /> <span class="custom-cart-count"><div id="mini-cart-count"></div></span> </a> 
                
                <a class="headcartcount cart-customlocation" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'ad-agency-lite' ); ?>"><span class="custom-cart-total"><div id="mini-cart-total"></div></span> </a>  
            </div>   
            <?php } ?>
                 <div class="clear"></div>
            </div>
